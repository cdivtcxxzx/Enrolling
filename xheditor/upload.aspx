...
protected void Page_Load(object sender, EventArgs e)
{
    ...
    int maxattachsize = 104857600;     // 最大上传大小，默认是100M
    string upext = "txt,rar,zip,jpg,jpeg,gif,png,swf,wmv,avi,wma,mp3,mid,pdf,doc,docx,xls,xlsx,mp4,flv";    // 上传扩展名
        ...
        else
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    fs.Close();
                    //存幻灯图片
                    if ("jpg,jpeg,gif,png".Contains(extension))
                    {
                        Session["image"] = target;
                    }
