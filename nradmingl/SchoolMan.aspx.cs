...
public partial class admin_SchoolMan : System.Web.UI.Page
{
    #region 页面初始化参数

    private string pagelm1 = "学校管理";
    ...
    private string webpage = "SchoolMan.aspx";//页面值
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //登陆验证,权限验证,日志
        new c_login().tongyiyz(pagelm1, pageqx1, "进入学校管理页", true, pageqx1, pageqx2, pageqx3, pageqx4, pageqx5);
        if (!IsPostBack)
        {
    ...
    protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        ...
        {       //string xx = textbox.Text;
            if (Sqlhelper.ExcuteNonQuery("delete from ZY_SCHOOL  where school_id='" + id + "'") > 0)
            {
