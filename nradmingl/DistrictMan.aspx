<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistrictMan.aspx.cs" Inherits="admin_DistrictMan" %>
...
<body id="C_User">
	...
	<tr>
		<td>
			<a href="?action=manage">当前位置&gt;&gt;&nbsp;区县管理</a>
			<%--<a href="yonghadd.aspx">添加用户</a>--%>
           <a href="DistrictUpdate.aspx?mode=add">手动添加</a>
      ...
      >
        <Columns>
         ...
         <HeaderStyle Width="1" Height="28px" HorizontalAlign="Center" />  
            ...
            <asp:BoundField DataField="code" HeaderText="编码"  HeaderStyle-Width="70"  SortExpression="code" >
            
            <HeaderStyle Width="70px" />
            
            </asp:BoundField>
            <asp:BoundField DataField="name" HeaderText="区县名称"  SortExpression="name"  
...
<%--            <asp:ButtonField HeaderText="管理" Text="查看"  HeaderStyle-Width="25" >
            ...
            <asp:HyperLinkField DataNavigateUrlFormatString="DistrictUpdate.aspx?mode=edit&code={0}"   HeaderStyle-Width="25" DataNavigateUrlFields="code" Text="修改" HeaderText="管理" />

             <asp:TemplateField  HeaderText="删除"  >
            
            <ItemTemplate>
<asp:LinkButton ID="Button3" runat="server" CommandName="删除"  CommandArgument='<%#Eval("code")%>'  OnClientClick="return confirm('是否删除')"   Text='删除'>   </asp:LinkButton>
...
<span style="float:left;">
    ...
    <asp:ObjectDataSource 
         ...
         TypeName="District"
         SelectMethod="getAll"
         runat="server" SelectCountMethod="" OnSelected="srcAccount_Selected"
    />
    <asp:ObjectDataSource
         ID="accountSearch"
          runat="server" SelectMethod="getByKey" TypeName="District" OnSelected="accountSearch_Selected"
    >
        <SelectParameters>
