<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xwsh.aspx.cs" Inherits="admin_xwsh" %>
...
<body>
	...
	<tr>
		<td>
        <asp:LinkButton runat="server" ID="LB_top" Text="新闻审核&gt;&gt;&nbsp;全部新闻"></asp:LinkButton></td><td style="text-align:right">
...
&nbsp;</td>
    ...
    <asp:BoundField DataField="lmmc" HeaderText="栏目" SortExpression="lmmc"/>
     <asp:TemplateField HeaderText="标题"  SortExpression="title">
            ...
            <ItemTemplate>
            <a href="/xw.aspx?xwid=<%# Eval("id").ToString() %>&sh=0"  txttop="txttop"  target="_blank"  title="点击查看新闻"><%# Eval("title").ToString() %><%# imagestu(Eval("images").ToString()) %></a>
            </ItemTemplate>
   ...
   <asp:TemplateField HeaderText="状态"  SortExpression="title">
    ...
    <%--<asp:BoundField DataField="titleurl" HeaderText="标题"  HtmlEncode="false" HtmlEncodeFormatString="false" />--%>
        ...
        <asp:TemplateField HeaderText="">
                ...
                <ItemTemplate>
             <a href="xwshcl.aspx?id=<%# Eval("id").ToString() %>"  txttop="txttop"  title="编辑新闻">审核</a> &nbsp;&nbsp;<asp:LinkButton ID="LinkButton2" runat="server" CommandName="删除"  CommandArgument='<%#Eval("id")%>'    Text='删除' >      
              </asp:LinkButton>
            </ItemTemplate>
