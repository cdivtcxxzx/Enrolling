...
public partial class admin_DistrictMan : System.Web.UI.Page
{
    #region 页面初始化参数

    private string pagelm1 = "区县管理";
    ...
    private string webpage = "DistrictMan.aspx";//页面值
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //登陆验证,权限验证,日志
        new c_login().tongyiyz(pagelm1, pageqx1, "进入区县管理页", true, pageqx1, pageqx2, pageqx3, pageqx4, pageqx5);
        if (!IsPostBack)
        {
    ...
    protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        ...
        {       //string xx = textbox.Text;
            if (Sqlhelper.ExcuteNonQuery("delete from ZY_DISTRICT  where code='" + id + "'") > 0)
            {
