...
public partial class nradmingl_xsxx_dr : System.Web.UI.Page
{
    #region 页面初始化参数
    ...
    //导入模板的字段
    private string zd = "高考报名号,姓名,性别,身份证号,民族,专业代码,学制,年级,联系电话,备注";
                        ...
                        if (x.Rows[ii]["错误提示"].ToString().Length < 1)
                        {
                            ...
                            try
                            {
                                ...
                                Base_STU createStu = new Base_STU
                                {
                                    ...
                                    Note = x.Rows[ii]["备注"].ToString().Trim().Replace("'", "")
                                };
