...
public partial class admin_yonghgl : System.Web.UI.Page
{
    #region 页面初始化参数

    private string pagelm1 = "用户管理";
    ...
    private string webpage = "yonghgl.aspx";//页面值
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //登陆验证,权限验证,日志
        new c_login().tongyiyz(pagelm1, pageqx1, "进入用户管理页", true, pageqx1, pageqx2, pageqx3, pageqx4, pageqx5);
        if (!IsPostBack)
        {
    ...
    protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        ...
        {       //string xx = textbox.Text;
            if (Sqlhelper.ExcuteNonQuery("delete from yonghqx  where yhid='" + id + "'") > 0)
            {
