<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolUpdate.aspx.cs" Inherits="admin_SchoolUpdate" %>
...
<body id="C_User">
	...
	<tr>
		<td colspan="2">
			<asp:HyperLink runat="server" ID="toplink" NavigateUrl="#" Text="当前位置&gt;&gt;&nbsp;添加学校"></asp:HyperLink><a href="DistrictMan.aspx">返回</a>
   ...
   <tr>
			<td  class="style1">学校名称&nbsp;<a href="#" class="help">[?]</a></td>
			<td  >
			<span class="note">学校名称</span>&nbsp;
        	...
        	<tr>
			<td  class="style1">学校代码&nbsp;<a href="#" class="help">[?]</a></td>
			<td >
			<span class="note">学校代码,不能重复</span>&nbsp;
                <asp:TextBox ID="TB_code" runat="server" ontextchanged="TB_code_TextChanged" AutoPostBack="true"></asp:TextBox>
         ...
         <tr>
			<td  class="style1">选择区县&nbsp;<a href="#" class="help">[?]</a></td>
			<td  >
			<span class="note">分配所属区县</span>&nbsp;
                <asp:DropDownList ID="DropDownList3" runat="server" DataTextField="name" DataValueField="code"  DataSourceID="SqlDataSource3" OnDataBound="DropDownList3_DataBound">
                    
                </asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
        ConnectionString="<%$ ConnectionStrings:SqlConnString %>" 
        SelectCommand="SELECT code,name FROM [zy_district]"></asp:SqlDataSource>
                <asp:TextBox ID="TB_qx" runat="server" Visible="false"></asp:TextBox>
            </td>
		</tr>	
        <tr>
			<td  class="style1">学校帐号&nbsp;<a href="#" class="help">[?]</a></td>
			<td >
