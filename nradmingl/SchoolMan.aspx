<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchoolMan.aspx.cs" Inherits="admin_SchoolMan" %>
...
<body id="C_User">
	...
	<tr>
		<td>
			<a href="?action=manage">当前位置&gt;&gt;&nbsp;学校管理</a>
			<%--<a href="yonghadd.aspx">添加用户</a>--%>
           <a href="SchoolUpdate.aspx?mode=add">手动添加</a>
      ...
      >
        <Columns>
         ...
         <HeaderStyle Width="1" Height="28px" HorizontalAlign="Center" />  
            ...
            <asp:BoundField DataField="school_id" HeaderText="学校id"  HeaderStyle-Width="70"  SortExpression="school_id" >
...
<%--            <asp:ButtonField HeaderText="管理" Text="查看"  HeaderStyle-Width="25" >
            ...
            <asp:HyperLinkField DataNavigateUrlFormatString="SchoolUpdate.aspx?mode=edit&id={0}"   HeaderStyle-Width="25" DataNavigateUrlFields="school_id" Text="修改" HeaderText="管理" />

             <asp:TemplateField  HeaderText="删除"  >
            
            <ItemTemplate>
<asp:LinkButton ID="Button3" runat="server" CommandName="删除"  CommandArgument='<%#Eval("school_id")%>'  OnClientClick="return confirm('是否删除')"   Text='删除'>   </asp:LinkButton>
...
<span style="float:left;">
    ...
    <asp:ObjectDataSource
         ID="accountSearch"
          runat="server" SelectMethod="getByKey" TypeName="School" OnSelected="accountSearch_Selected"
    >
        <SelectParameters>
