...
public partial class nradmingl_tj_sf : System.Web.UI.Page
{
    /// <summary>
    /// 执行查询
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        newrow["学院名称"] = "全院合计";
        newrow["录取学生数"] = Convert.ToString(tj.Compute("Sum(录取学生数)", "")); ;
        newrow["已缴学费"] = Convert.ToString(tj.Compute("Sum(已缴学费)", "")); ;
