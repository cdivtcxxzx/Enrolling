<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bzr_stu.aspx.cs" Inherits="nradmingl_Default3" validateRequest="false"  %>
...
<%--              <asp:HiddenField ID="pk_batch_no" Value="" runat="server" />--%>
        <div class="admin-main">
            <blockquote class="layui-elem-quote">
                <i class="layui-icon">&#xe602;</i>辅导员<i class="layui-icon">&#xe602;</i>查看学生信息           
            </blockquote>
            <div>                
