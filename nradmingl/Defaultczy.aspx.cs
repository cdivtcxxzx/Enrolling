...
public partial class nradmingl_Defaultczy : System.Web.UI.Page
{
    #region 页面初始化参数
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Session["pk_batch_no"] = "1";
        //Session["pk_staff_no"] = "huyuan";
    ...
    {
        this.czmain.InnerHtml = "<iframe src=\"/view/ssfp-yfp.aspx\"></iframe>";
    }
}