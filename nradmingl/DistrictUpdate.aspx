<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistrictUpdate.aspx.cs" Inherits="admin_DistrictUpdate" %>
...
<body id="C_User">
	...
	<tr>
		<td colspan="2">
			<asp:HyperLink runat="server" ID="toplink" NavigateUrl="#" Text="当前位置&gt;&gt;&nbsp;添加区县"></asp:HyperLink><a href="DistrictMan.aspx">返回</a>
   ...
   <tr>
			<td  class="style1">区县名称&nbsp;<a href="#" class="help">[?]</a></td>
			<td  >
			<span class="note">区县名称</span>&nbsp;
        ...
        SelectCommand="SELECT * FROM [dm_yuanxi]"></asp:SqlDataSource>
        	...
        	<tr>
			<td  class="style1">区县代码&nbsp;<a href="#" class="help">[?]</a></td>
			<td >
			<span class="note">区县代码,不能重复</span>&nbsp;
        ...
        <tr>
			<td  class="style1">区县帐号&nbsp;<a href="#" class="help">[?]</a></td>
			<td >
