<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yonghglxbadd.aspx.cs" Inherits="admin_yonghglxbadd" %>
...
<body id="C_User">
	...
	<tr>
		<td colspan="2">
			<a href="?action=manage">当前位置&gt;&gt;&nbsp;直接添加新用户</a>
   ...
   <tr>
        ...
        <tr>
			<td  class="style1">部门&nbsp;<a href="#" class="help">[?]</a></td>
			<td  >
			<span class="note">分配用户所属部门</span>&nbsp;
        ...
        SelectCommand="SELECT * FROM [dm_yuanxi] where zt=1"></asp:SqlDataSource>
            </td>
		</tr>	
        	<tr>
