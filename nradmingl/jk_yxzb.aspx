<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jk_yxzb.aspx.cs" Inherits="nradmingl_jk_yxzb" %>
...
<body>
    ...
    <div class="admin-main">
      <blockquote class="layui-elem-quote">&nbsp;<span class=" hidden-xs">
          <i class="layui-icon">&#xe602;</i>迎新准备进度监控<i class="layui-icon">&#xe602;</i>按院系筛选</span>
 ...
 <%--               <a href="#" class="layui-btn layui-btn-small hidden-xs">
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:SqlConnString %>" SelectCommand="select '0' yxdm,'信息工程学院' yxmc union(SELECT [YXDM], [YXMC] FROM [DM_YUANXI] WHERE (([isjx] = @isjx) AND ([zt] = @zt))) ORDER BY [YXDM]">
                <SelectParameters>
...
<table  class="site-table table-hover" cellspacing="0" rules="all" border="1" style="border-collapse: collapse;">
                    ...
                    <thead>
<tr><th scope="col">序号</th><th scope="col">准备阶段</th><th scope="col">数量</th><th scope="col">完成百分比</th><th scope="col">详细情况</th></tr></thead>
    
    <tbody>
<tr><td >1</td><td >新生数据导入</td><td>200</td><td>100%</td><td><a href="#" onclick="studentdetail(201761021103005)" class="layui-btn layui-btn-mini" title="按班查看详情">按班查看详情</a></td></tr>
<tr><td >2</td><td >班级设置</td><td>6</td><td>100%</td><td><a href="#" onclick="studentdetail(201761021103005)" class="layui-btn layui-btn-mini" title="按班查看详情">按班查看详情</a></td></tr>
<tr><td >3</td><td >辅导员设置</td><td>6</td><td>100%</td><td><a href="#" onclick="studentdetail(201761021103005)" class="layui-btn layui-btn-mini" title="按班查看详情">按班查看详情</a></td></tr>
<tr><td >4</td><td >学生分班</td><td>180</td><td>90%</td><td><a href="#" onclick="studentdetail(201761021103005)" class="layui-btn layui-btn-mini" title="按班查看详情">按班查看详情</a></td></tr>
<tr><td >5</td><td >预分寝室</td><td>180</td><td>90%</td><td><a href="#" onclick="studentdetail(201761021103005)" class="layui-btn layui-btn-mini" title="按班查看详情">按班查看详情</a></td></tr>
