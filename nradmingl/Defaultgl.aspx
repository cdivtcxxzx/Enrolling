				...
				<div class="layui-main">
                    ...
                    <li class="layui-nav-item" id="tsxx" runat="server"> </li>
						...
						<li class="layui-nav-item  hidden-xs">
							<a href="/default.aspx"><i class="fa fa fa-home" aria-hidden="true"  style="margin-right:2px;"></i>前台首页</a>
						</li>
                        
						<li class="layui-nav-item  hidden-xs">
							<a href="/default.aspx"><i class="fa fa-user-plus" aria-hidden="true"  style="margin-right:2px;"></i>招生系统</a>
						</li>
                        <li class="layui-nav-item  hidden-xs">
							<a href="/default.aspx"><i class="fa fa-user-circle-o" aria-hidden="true"  style="margin-right:2px;"></i>迎新系统</a>
						</li>
                        <li class="layui-nav-item  hidden-xs">
							<a href="/default.aspx"><i class="fa fa-users" aria-hidden="true" style="margin-right:2px;"></i>学工系统</a>
						</li>
