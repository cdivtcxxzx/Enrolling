<%@ Page Language="C#" AutoEventWireup="true" CodeFile="message_show_new.aspx.cs" Inherits="admin_message_show_new" %>
...
<body>
	...
	<tr>
		<td>
        <asp:LinkButton runat="server" ID="LB_top" Text="消息提醒&gt;&gt;&nbsp;未读消息"></asp:LinkButton>
...
&nbsp;</td>
    ...
    <div>
    <asp:GridView ID="GV_new" runat="server" AutoGenerateColumns="false" DataSourceID="Sql_new" CssClass="table" OnRowCommand="GridView1_RowCommand" PageSize="10" EmptyDataText="你没有<font color='red'>新的</font>消息及提醒!">
    <Columns>
    ...
    <asp:ObjectDataSource ID="Sql_new" runat="server" 
        SelectMethod="GetNew" TypeName="Message">
        <SelectParameters>
    ...
    >
        <SelectParameters>
            <asp:ControlParameter ControlID="searchtext" Name="key" PropertyName="Text" 
                Type="String" />
            <asp:Parameter DefaultValue="未读" Name="mode" Type="String" />
            <asp:SessionParameter Name="recid" SessionField="UserName" />
        </SelectParameters>
    </asp:ObjectDataSource>
    </div>
