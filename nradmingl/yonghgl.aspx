<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yonghgl.aspx.cs" Inherits="admin_yonghgl" %>
...
<body id="C_User">
	...
	<tr>
		<td>
			...
			<a href="uumyh.aspx">添加UUM用户</a>
           <a href="yonghglxbadd.aspx">手动添加用户</a>
...
<%--            <asp:ButtonField HeaderText="管理" Text="查看"  HeaderStyle-Width="25" >
            ...
            <ItemTemplate>
<asp:LinkButton ID="Button3" runat="server" CommandName="删除"  CommandArgument='<%#Eval("yhid")%>'    Text='删除'>   </asp:LinkButton>
