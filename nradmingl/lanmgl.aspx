<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lanmgl.aspx.cs" Inherits="admin_lanmgl" %>
...
<table class="table subsubmenu">
	        ...
	        <tr>
		       <td>
			   <a href="#">当前位置&gt;&gt;&nbsp;栏目管理系统</a>
			   <a href="lanmadd.aspx?action=add">添加栏目模块</a>
		       </td>
	        </tr>
            </thead>
        </table>
...
<asp:ListView 
    ...
    <ItemTemplate>
        <tr id='<%#(Convert.ToString(Eval("lmid")))%>'>
            ...
            <td class="manage"><a href="javascript:Button1_onclick('lanmadd.aspx?id=<%#(Convert.ToString(Eval("lmid")))%>&action=edit')"  class="copy">修改</a>
        ...
        <asp:SqlDataSource 
            ...
            runat="server" 
            ConnectionString="<%$ ConnectionStrings:SqlConnString %>"
            SelectCommand="SELECT * FROM lanm WHERE fid=@fid OR fid=@fid2 order by px">
            <SelectParameters>
...
<script  type="text/javascript" src="/nradmingl/artDialog/plugins/iframeTools.source.js"></script>
