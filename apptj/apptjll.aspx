<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apptjll.aspx.cs" Inherits="admin_apptjll" %>
...
<body>
	...
	<tr>
        ...
        <td style="width:80px" ><a href="apptjtb.aspx">柱状图</a></td><td style="width:80px" ><a href="apptjbt.aspx">饼图</a></td><td style="width:80px" ><a href="?action=manage">流量图</a></td>
