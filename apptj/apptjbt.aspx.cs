...
public partial class admin_apptjbt : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            this.jsshow.InnerHtml = " <script>  $(document).ready(function () { $('#container').highcharts({chart: {plotBackgroundColor: null,plotBorderWidth: null,plotShadow: false },                title: {                    text: ''                },";
