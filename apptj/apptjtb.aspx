<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apptjtb.aspx.cs" Inherits="admin_apptjtb" %>
...
<body>
	...
	<tr>
        ...
        <td style="width:80px" ><a href="?action=manage">柱状图</a></td><td style="width:80px" ><a href="apptjbt.aspx">饼图</a></td><td style="width:80px" ><a href="apptjll.aspx">流量图</a></td>
