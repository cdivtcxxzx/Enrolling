           ...
           //高职
			lb = "高职";
                ...
                if (yxtj.Rows.Count > 0)
                {
                    ...
                    zzbdrs1 = yxtj.Rows[0]["网上注册"].ToString();
                ...
                //头部
                this.zs.InnerHtml = "<div class=\"progress-group\"><span class=\"progress-text\">总计</span><span class=\"progress-number\">注册:<b>" + s2 + "</b>/录取:" + s1 + "&nbsp;&nbsp;&nbsp;&nbsp;<font color=green><b>" + result + "</b></font></span>";
       ...
       // DataTable zydm = Sqlhelper.Serach("select 专业名称 yxmc,专业代码 yxdm from [zsgl_zsjh] where yxdm='0115' and 年度='"+nd+"'");
        ...
        if (yxdm.Rows.Count > 0)
        {
                     ...
                     if (yd != "0")
            {
				...
				{
                    this.yxshow.InnerHtml += "<div   class=\"progress-group\"><span class=\"progress-text\"><a href='/nradmingl/tj_yx.aspx?url=zc&id=" + yxdm.Rows[i]["yxdm"].ToString() + "'>" + yxdm.Rows[i][0].ToString() + "</a></span><span class=\"progress-number\"><b>" + sd + "</b>/" + yd + "&nbsp;&nbsp;&nbsp;&nbsp;<font color=green><b>" + bdl + "</b></font></span>";
				}
