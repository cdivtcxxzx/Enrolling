      ...
      <div class="wrap" style="text-align:center">
        <div class="layout" id="layout">
          ...
          <div class="mainbox" id="login-main" style="display: block;">
            ...
            <!-- 其他登录方式 e -->
            <div class="n_links_area" id="custom_display_64" style="display:none" runat="server">
			<a class="outer-link" href="/">返回首页</a><span>|</span>
              <a class="outer-link" href="#" onclick="layer.open({  type: 2,  title: '学生重置登录密码',  area : ['90%' , '80%'],  content: '/view/xsxx_pwd_reset.aspx'  });">忘记密码？</a>
            </div>
          </div>
