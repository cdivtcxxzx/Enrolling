<%@ page language="C#" autoeventwireup="true"  CodeFile="serch.aspx.cs" Inherits="wblue_serch" %>
...
<body  class="wp-main-page"  style="    background: #F8F8F9 url(img/cloud-bar.png) repeat-x;padding-top: 10px;">
    	...
    	<div class="wp-inner clearfix">
    		<div class="wp-panel main-nav-panel panel-5" frag="面板75">
    			<div class="wp-window main-nav-window window-5" frag="窗口75">
		            ...
		            <ul class="wp-menu clearfix" data-nav-aside='{"title":"站点导航","index":0}'>
                        ...
                        <ul class="wp-menu clearfix" data-nav-aside='{"title":"服务导航","index":1}'>
        ...
        <div class="navbar" frag="面板14">
    	       <div class="navbox" frag="窗口14">
      	              <div id="wp_nav_w14">
                          ...
                          <div onClick="location.href='/'" id=test3 style="PADDING-LEFT: 0px; WIDTH: 40px; PADDING-RIGHT: 0px; BACKGROUND: url(images/navhome1.png) no-repeat; FLOAT: left; HEIGHT: 40px;cursor:pointer"></div>
                ...
                <div class="column-news-box">
                    <div class="list-head" frag="面板88">
                        <div class="list-meta clearfix" frag="窗口88" portletmode="simpleColumnAttri">
                            ...
                            <h2 class="column-title" id="lmmc2" runat="server">新闻搜索结果</h2>
                            <div class="column-path" id="lmdh" runat="server"><span class="path-name">当前位置：</span><a href="/" target="_self">首页</a><span class='possplit'>&nbsp;&nbsp;</span><a href="#" target="_self">新闻搜索</a><span class='possplit'>&nbsp;&nbsp;</span><a href="#" target="_self">搜索结果</a></div>
...
.borderSolid1CCC
{
    ...
    width:32px;
                                    ...
                                    <div id="wp_content_w89_0" class="paging_content" style="display:" runat="server">
  ...
  <asp:TemplateField HeaderText=""  SortExpression="title">
    ...
    <%--<asp:BoundField DataField="titleurl" HeaderText="标题"  HtmlEncode="false" HtmlEncodeFormatString="false" />--%>
        <asp:BoundField DataField="fabutime" HeaderText="发布时间" DataFormatString="{0:yyyy年M月dd日}" 
...
<span style="float:left;height:40px;margin-top:10px;">
            ...
            <asp:LinkButton ID="LinkButtonGo" runat="server"  Text="跳转" OnClick="LinkButtonGo_Click" /></span><span style="float:right;height:40px;margin-top:10px;"><b>新闻数:<%#ViewState["count"].ToString()%>条</b>&nbsp;</b></font>&nbsp;&nbsp;&nbsp;每页显示<asp:TextBox ID="PageSize_Set" runat="server" Height="16px" Width="32px" CssClass="borderSolid1CCC"></asp:TextBox>条<asp:LinkButton ID="buttion2" runat="server"  Text="设置"   OnClick="PageSize_Go" /></span>
        </PagerTemplate>
    </asp:GridView>
        <asp:SqlDataSource onselected="SqlDataSource1_Selected"   ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:SqlConnString %>" 
                                            ...
                                            SelectCommand="SELECT row_number() over (order by  xw_neirong.fabutime desc)  AS 序号,xw_lanm.lmmc, xw_neirong.title, xw_neirong.author, xw_neirong.fabutime, xw_neirong.images,xw_neirong.isyn,xw_neirong.id,xw_lanm.glqx FROM xw_neirong INNER JOIN xw_lanm ON xw_neirong.LMID = xw_lanm.lmid where  isyn='1' and xw_neirong.title like'%'+@lmid+'%' order by fabutime desc">
            <SelectParameters>
                <asp:QueryStringParameter Name="lmid" QueryStringField="word" />
            </SelectParameters>
        </asp:SqlDataSource>
                                    </div>
                                </div>
