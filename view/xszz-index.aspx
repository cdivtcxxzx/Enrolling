...
<form class="layui-form layui-form-pane" action="">
     ...
     <div class="xsxx2"  >   <div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"  onClick="javascript:location.href='index2.aspx';">阅读报到须知</a></label>
		...
		<div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"  onClick="javascript:location.href='xsxx-confirm.aspx';">录取信息确认</a></label>
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
               <span id="xsxx_xh"><font color=red><b>未确认</b></font></span> </div></div>
				...
				<div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"  onClick="javascript:location.href='index2.aspx';">基础信息登记</a></label>
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
     ...
     <div  class="xsxx3"  >   
				...
				<div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"   style="width:120px"   onClick="window.location.href='pk_affair_no=7&pk_sno=6';">网上缴费</a></label>
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
               <span id="xsxx_xh"><font color=red><b>未缴费</b></font></span> </div></div>
        </div>
				<div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"  style="width:120px"    onClick="javascript:location.href='ssfp-yfp.aspx';">寝室选择</a></label>
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
