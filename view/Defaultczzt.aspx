...
<form class="layui-form layui-form-pane" action="">
     ...
     <div class="xsxx2"  >   <div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"  onClick="javascript:location.href='xszz-index.aspx';">学号规则设置</a></label>
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
               <span id="xsxx_xh"><font color=red><b>未设置</b></font></span> </div></div>
        </div>
		
		<div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"  onClick="javascript:location.href='xszz-index.aspx';">招生数据录入</a></label>
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
               <span id="xsxx_xh"><font color=red><b>无学生数据</b></font></span> </div></div>
        </div>
		
				<div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"  onClick="javascript:location.href='xszz-index.aspx';">设置班级数据</a></label>
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
               <span id="xsxx_xh"><font color=red><b>无班级数据</b></font></span> </div></div>
        </div>

         <div class="layui-form-item" pane="" style="min-height: 56px">
          <label class="layui-form-label" style="width:150px;"><a class="layui-btn"  onClick="javascript:location.href='xszz-index.aspx';">设置收费项目</a></label>
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
               <span id="xsxx_xh"><font color=red><b>未设置收费标准数据</b></font></span> </div></div>
        </div>
     ...
     <div  class="xsxx3"  >   
          ...
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
               <span id="xsxx_xh"><font color=red><b>未开始</b></font></span> </div></div>
        </div>
				<div class="layui-form-item" pane="" style="min-height: 56px">
		...
		<div class="layui-form-item" pane="" style="min-height: 56px">
          ...
          <div class="layui-input-block" style="margin-left:150px;">
           <div class="layui-form-mid layui-word-aux-ts" style="margin-left:40px;padding: 18px 0;">
               <span id="xsxx_xh"><font color=red><b>未分配</b>【查看各系分配详解】</font></span> </div></div>
        </div>
	 <div class="layui-form-item" pane="" style="min-height: 56px">
