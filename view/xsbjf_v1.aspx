<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xsbjf_v1.aspx.cs" Inherits="view_xsbjf_v1" %>
...
.responsive-utilities-test span {
    ...
    border-radius: 4px;
     ...
     <!--顶部提示及导航-->
            ...
            <i class="layui-icon">&#xe602;</i>迎新管理>>学生交费
...
<form class="layui-form layui-form-pane" runat="server">
     ...
     <div class="xsxx2" id="contents" >   
         ...
         <div class="layui-form-item" pane="" style="margin-top:6px;margin-bottom:0px;";>
               ...
               <div class="layui-input-block">
                <div class="layui-form-mid layui-word-aux-ts" style="margin-left:10px;"><asp:Label ID="Label1" runat="server" Text="金额(单位:元)"></asp:Label></div>
                </div>
         </div>
     </div>
    ...
    <div class="xsxx2" style="text-align:center;">
        <a href="javascript:void(0);" onclick="sure();" class="layui-btn layui-btn-small" id="sure" style="display:none;">缴费</a>
  ...
  <!--标签框架over-->
        ...
        <script type="text/javascript" src="../b_js/app/xsbjf_v1.js"></script>
